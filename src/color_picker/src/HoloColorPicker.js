...
import { TouchableOpacity, Slider, View, Image, StyleSheet, InteractionManager, Text } from 'react-native'
  ...
  render() {
    ...
    return (
      <View style={style}>
        ...
        <View>
          <Text style={{ marginTop: 15, }}>Brightness:</Text>
          <Slider value={s} onValueChange={this._onSValueChange} />
          <Text style={{ marginTop: 15, }}>Saturation:</Text>
